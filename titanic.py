...
t_madata = convert_to_categorical(t_madata, TEST_P_CLASS)
t_madata = convert_to_categorical(t_madata, TEST_SEX)
t_madata = convert_to_categorical(t_madata, TEST_EMBARKED)
